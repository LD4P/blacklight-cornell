 ...
 #     params[:sort] = "score desc, pub_date_sort desc, title_sort asc"
  ...
  def show
    ...
    respond_to do |format|
      ...
      # export formats.
      puts 'cornell_catalog.rb show'.to_yaml
      puts @document.export_formats.to_yaml
      puts format.to_yaml
      @document.export_formats.each_key do | format_name, content_type |
        # It's important that the argument to send be a symbol;
        # if it's a string, it makes Rails unhappy for unclear reasons.
        puts format_name.to_yaml
        puts content_type.to_yaml
